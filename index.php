...
<div class="jumbotron bg-light p-5 rounded mb-4">
    ...
    <?php else: ?>
    <div class="mt-4">
        <a href="create_commande.php" class="btn btn-primary btn-lg me-2"><?php echo __('create_order_now'); ?></a>
        <a href="dashboard.php" class="btn btn-secondary btn-lg"><?php echo __('my_dashboard'); ?></a>
    </div>
    <?php endif; ?>
</div>
